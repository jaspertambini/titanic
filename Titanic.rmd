...
Collinearity between variables is most significant in Fare-Class and Child-Age which both are expected to be true. In our case Random Forests
...
set.caption("Data on Titanic")
pander(titanic_results, style = 'rmarkdown')
```
